  ...
  return (
    <header className="flex justify-between items-center z-50 mx-5 mb-5 md:mb-0 md:mx-24">
      ...
      <div className="relative group">
        <div className="absolute dark:bg-orange rounded-2xl -inset-0.5 blur opacity-60 transition md:duration-1000 md:group-hover:duration-200 md:group-hover:opacity-100">
        </div>
