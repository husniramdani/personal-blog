...
export default function Navbar() {
  ...
  return (
    <header className="flex justify-between items-center z-20 mx-5 mb-5 md:mb-0 md:mx-24">
      <Link href="/">
      ...
      <div className="relative group">
        <div className="absolute dark:bg-orange rounded-2xl -inset-0.5 blur opacity-60 transition duration-1000 group-hover:duration-200 group-hover:opacity-100">
        </div>
